...
SimpleNavigation::Configuration.run do |navigation|
    ...
    navigation.items do |primary|
      ...
      primary.item :menu_questions, 'Questions', questions_path,  highlights_on: :subpath
      primary.item :menu_login, 'Log In',  new_user_session_path, unless: proc { user_signed_in? }
      primary.item :menu_logout, 'Log Out', destroy_user_session_path,  method: :delete, if: proc { user_signed_in? }
